...
////  MODIFICATION OF THE WIA HEADER TO SUPPORT C++
////  ADDED extern "C" TO THE EXPORTED FUNCTIONS
...
extern "C" WIAMICRO_API HRESULT MicroEntry(LONG lCommand, __inout PVAL pValue);
extern "C" WIAMICRO_API HRESULT Scan(__inout PSCANINFO pScanInfo, LONG lPhase, __out_bcount(lLength) PBYTE pBuffer, LONG lLength, __out LONG *plReceived);
extern "C" WIAMICRO_API HRESULT SetPixelWindow(__inout PSCANINFO pScanInfo, LONG x, LONG y, LONG xExtent, LONG yExtent);
